...
<?php include ('inc/_section_particles.php'); ?>

<?php include ('inc/navigation.php'); ?>

<?php include ('inc/_section_coming_soon.php'); ?>

<?php include ('inc/_section_productions.php'); ?>

<?php include ('inc/_section_about.php'); ?>

<?php include ('inc/_section_links.php'); ?>

<?php include ('inc/_section_contact.php'); ?>
